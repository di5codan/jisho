...
ございます and でございます are very stylized and are rarely heard outside of formal business related situations
...
If you do something without doing something else, the action no performed can be expressed as ～ない(short negative present) plus で. Note that the present tense form ～ない is used for both the present and past actions.
...
When talking about a person or a thing that goes by a certain name, but the person one is talking to might not be familiar with it, the following pattern can be used.
...
### [信号](../Vocabulary/信号.md)
### [神様](../Vocabulary/神様.md)
### [ハイヒール](../Vocabulary/ハイヒール.md)

## U Verbs
### ～[でござる](../Vocabulary/でござる.md)
### [伺う](../Vocabulary/伺う.md)
### [頂く](../Vocabulary/頂く.md)
### [曲がる](../Vocabulary/曲がる.md)
### [致す](../Vocabulary/致す.md)
### [参る](../Vocabulary/参る.md)
### [おる](../Vocabulary/おる.md)
### ～[ておる](../Vocabulary/ておる.md)
### [ござる](../Vocabulary/ござる.md)
### [戻る](../Vocabulary/戻る.md)
### [申す](../Vocabulary/申す.md)

## Ru-verbs and Irregular Verbs
### [交換する](../Vocabulary/交換する.md)
### [差し上げる](../Vocabulary/差し上げる.md)
### [生活する](../Vocabulary/生活する.md)
### [聞こえる](../Vocabulary/聞こえる.md)
### [返品する](../Vocabulary/返品する.md)
### [待たせる](../Vocabulary/待たせる.md)
### [伝える](../Vocabulary/伝える.md)
### [続ける](../Vocabulary/続ける.md)

## Adverbs + Expressions
### ～[みたいなX](../Vocabulary/みたいな.md)
